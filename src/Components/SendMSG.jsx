...
export const SendMSG = () => {
  ...
  return (
    ...
    >
      <Link to="/ContactMSG">
        <button
          className=" cursor-pointer overflow-hidden z-50 xl:text-[20px] lg:text-20px md:text-[20px] sm:text-[20px] text-[16px] text-[#91040c] font-GeneralSans 
      bg-black xl:px-[100px] lg:px-[100px] md:px-[100px] sm:px-[80px] px-[60px] py-[10px] border-4 border-black 
         rounded-2xl hover:shadow-2xl hover:drop-shadow-2xl hover:text-black hover:scale-[1.2] hover:border-black hover:bg-transparent after:content-[''] 
         after:h-[80px] after:w-[200px] after:bg-[#91040c] after:border-0 after:rounded-[500px]
