    ...
    <footer className=" mt-[120px] p-6 selection:bg-white selection:text-black bg-black text-white relative ">
      <div className=" flex justify-between items-start mb-[50px] ">
        ...
        >
          ...
          {/* <form
            className=" flex flex-col justify-center items-start p-10 absolute left-[-100px] top-0 bg-transparent rounded-xl scale-0 opacity-0 z-50
             group-hover:bg-Khaki group-hover:top-[-600px] group-hover:left-[-200px] group-hover:scale-100 group-hover:opacity-100 delay-400 duration-300 ease-out "
          >
            ...
            />
            <button
              className="font-GeneralSans text-[18px] tracking-widest text-white bg-black px-[20px] py-[10px] mt-[16px] border-3 border-black rounded-lg ml-[-2px] cursor-pointer "
            >
              Send
            </button>
          </form> */}
