...
export const Contact = () => {
  ...
  return (
    <section className=" h-[100vh] " >
      ...
      <ContainerSec>
        <h2 className=" xl:text-[40px] lg:text-[35px] text-[30px] font-cabinet text-center text-black xl:leading-[75px] lg:leading-[60px] md:leading-[60px] sm:leading-[50px] leading-[50px]
         selection:text-white selection:bg-black mt-[60px] mb-[120px] ">
